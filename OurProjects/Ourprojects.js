...
import parcedemarl_bigimg from "../images/parcedemarl_bigimg.png";
      ...
      <div className={blurBackground ? "blur-background" : ""}>
        ...
        <main className="px-6 md:px-16 py-16 lg:px-32 bg-black">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className="flex justify-between items-center border border-white mb-3 px-2 text-white font-light text-base lg:text-lg">
            ...
            <div className="grid grid-rows-2 gap-3">
              ...
              >
                ...
                <div>
                  <img
                    className="object-center object-cover h-full w-full"
                    src={ProjectcoworkingFlyingSaucer}
                  />
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 flex justify-center items-center">
            ...
            <button onClick={togglePopup} className="bg-white ml-6 py-1 px-3">
              Contact us
            </button>
          </div>
        </main>
