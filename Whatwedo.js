        ...
        <div className="">
          ...
          <div className="relative">
            ...
            <div className="py-44">
              ...
              {/* == Human Centric == */}
              <div className="bg-[#E5E7EB] mt-8 xl:py-9 md:py-7 py-5 flex flex-row justify-between px-10 sm:px-32 ">
                <div className="font-light text-black text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-6xl ">
              ...
              {/* == Sustainable Process == */}
              <div className="bg-[#E5E7EB] mt-16 xl:py-9 md:py-7 py-5 flex flex-row justify-between px-10 sm:px-32 ">
                <span className="font-light text-black text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-6xl ">
                  Sustainable spaces
                </span>
                <img
                  className="xl:h-16 lg:h-12 h-8"
                  alt="button"
                  src={vector}
                  onClick={() => {
                    openPopup(
